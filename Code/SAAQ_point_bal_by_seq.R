...
head(saaq_point_hist[, c('seq', 'date', 'last_date')], 20)
head(saaq_point_hist[, c('seq', 'date', 'next_date')], 20)

head(saaq_point_hist[, c('seq', 'date', 'next_date', 'points', 'num')], 20)
...
# Consider only those ocurring during the sample period.
...
saaq_point_hist[sum_num != 1460, seq]
